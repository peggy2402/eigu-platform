...
const TESTIMONIALS_COL1 = [
  ...
  { name: 'Quốc Việt', handle: '@viet.tool', avatar: 'https://eigu.site/2.jpg', text: 'Tool TikTok Beta quét chuẩn, giúp mình tìm được nhiều niche ngon.' },
  { name: 'Hoàng Vũ', handle: '@hoangvu_reup', avatar: 'https://eigu.site/3.jpg', text: 'Render GPU FFmpeg quá đỉnh, xuất 100 video ngắn chưa tới 5 phút.' },
];

const TESTIMONIALS_COL2 = [
  { name: 'Quỳnh Nga', handle: '@quynhnga03', avatar: 'https://eigu.site/4.jpg', text: 'Bên này giá rẻ nhưng chất lượng rất xịn. Proxy nhanh và sạch. Rất hợp để làm scraping.' },
  { name: 'Nguyên Lê', handle: '@nguyenle', avatar: 'https://eigu.site/5.jpg', text: 'Tốc độ cực nhanh, giá hợp lý. Affiliate thì trả hoa hồng sòng phẳng. Thật sự là lựa chọn sáng suốt.' },
  { name: 'Hoàng Sói', handle: '@hoangsoi222', avatar: 'https://eigu.site/6.jpg', text: 'Tích hợp AI lồng tiếng đa ngôn ngữ chuẩn từng câu, kênh YouTube tăng trưởng 3x.' },
];

const TESTIMONIALS_COL3 = [
  { name: 'Hải Trần', handle: '@haitran.ai', avatar: 'https://eigu.site/7.jpg', text: 'Rất đáng để gắn bó lâu dài. Support nhiệt tình, tool update liên tục.' },
  { name: 'Thẩm Dương', handle: '@duongtham.mkt', avatar: 'https://eigu.site/8.jpg', text: 'Mình thích nhất tính năng lọc Proxy theo quốc gia, rất tiện cho việc nuôi nick.' },
  { name: 'Việt Đặng', handle: '@dangviet_crypto', avatar: 'https://eigu.site/9.jpg', text: 'Bypass Content ID TikTok mượt mà, không lo dính gậy bản quyền nữa!' },
];
