  ...
  <nav class="sidebar-nav">
    ...
    <div class="nav-item-wrapper">
      ...
      <div class="nav-sub">
        ...
        <div class="nav-sub-item cong-cu" data-sub="ai-video" onclick="switchView('ai-video', document.querySelector('[data-view=cong-cu]'), 'ai-video', event)"><span data-icon="zap" style="vertical-align:middle;margin-right:4px;"></span> <span data-i18n="sub_ai_video">Tạo video AI (Nhanh)</span></div>
        <div class="nav-sub-item cong-cu" data-sub="ai-studio" onclick="switchView('ai-studio', document.querySelector('[data-view=cong-cu]'), 'ai-studio', event)"><span data-icon="folder" style="vertical-align:middle;margin-right:4px;"></span> <span data-i18n="sub_ai_studio">AI Video Studio (.eigu)</span></div>
